...
<script language="JavaScript" src="<?php echo $jqueryslidemenupath ?>scriptcam.js"></script>
	...
	<body>
            <?php $epe_id=yii::app()->session['EPE_ID'];
              $can=yii::app()->session['Cand']; 
             $epj_id=yii::app()->session['Job_Post_Id'];
             $videoid=$epe_id.$can.$epj_id;
             ?>
...
<!--                <p> <?php echo $EMP_COMP_NAME;?> has requested a brief introduction from you, to be recorded over video.<br> Please accept to continue. You have 60 seconds. </p></div>-->
                    ...
                    <p align="center"> <?php echo $EMP_COMP_NAME;?> has requested a brief overview of you , which will be recorded. You will have about 1 minute to pitch yourself, your experience, technology skills and highlights. </p> <br>  <br>
                    <p align="center">   
                    Once completed, you will be redirected to the test. 
                    </p></div>
...
<input type="hidden" id="videofilename" name="videofilename" > 
	<span style="padding-left:5px;padding-right:5px;">
			...
			<input type="button" id="recordStopButton" class="btn btn-small" onclick="closeCamera()"  value="Stop" disabled> 
                       	<input type="button" id="resetButton" class="btn btn-small" onclick="reset()"  value="Re-shoot" disabled  style="display: none">
...
<br>
           ...
           <div id="mediaplayer" style="display: none;float:right;" >
...
<div id="loading"></div>-->
	...
	<script>
			...
			function closeCamera() {
                           ...
                           alert("Please wait for a few seconds till your video is processed");
                    ...
                    if(videofilename=='')
                        {
                       ...
                       else
                           {
                            document.getElementById('mediaplayer').style.display='block';
                              $('#mediaplayer').load('<?php echo Yii::app()->request->baseUrl;?>/CandidateTest/viewrendervideo?videofilename='+videofilename);
                              //document.getElementById('mediaplayer').style.display='block'; 
